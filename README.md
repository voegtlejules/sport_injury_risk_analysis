...
## Key Features
*   **Dual Model Comparison**: Evaluates and interprets a Regularized Logistic Regression alongside a Random Forest classifier.
...
*   **Local Individual Interpretability**: Leverages **SHAP (SHapley Additive exPlanations)** values to provide actionable, player-specific clinical diagnoses (e.g., quantifying the exact probability shift associated with a player's sleep schedule or nutrition quality).
